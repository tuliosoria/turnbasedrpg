...
export const CRISIS_RULES: string[] = [
  "O MOMENTO. Leia a crônica em ordem: o último resultado público e o evento atual definem onde o reino está agora. Uma cidade que caiu não continua sitiada, e uma guerra não vira trimestre normal só porque o novo turno abriu sem evento.",
