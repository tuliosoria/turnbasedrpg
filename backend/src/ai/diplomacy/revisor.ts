...
export const REVIEW_SYSTEM_PROMPT = [
  ...
  // Saiu do prompt do escritor e veio para cá. Lá, a exigência de "toda carta
  // precisa mover alguma coisa" só conseguia adivinhar antes de haver texto, e
  // o preço de adivinhar era transformar toda carta num contrato com prazo.
  // Aqui a carta já existe, e dá para simplesmente ler se ela disse algo.
  "6. CARTA QUE NÃO DIZ NADA. Ela elogia a iniciativa, concorda em princípio e promete conversar depois, sem decidir, exigir, recusar, marcar, avisar nem contar nada novo? Devolva-a com o movimento que faltava, tirado do próprio material. Este é o único defeito em que você pode ACRESCENTAR em vez de cortar.",
  "7. FORMULÁRIO. A carta empilha número, rota, prazo e condição desde o primeiro parágrafo, e o que ela quer só aparece no fim. Reordene: o ponto nas duas primeiras frases, a logística por último. Corte número que não muda a resposta de ninguém. Se houver prazo em dias e ele não for essencial, tire — dezessete cartas em dezoito com data marcada é o que faz um reino soar como um só escritório.",
  "8. VOZ DE QUALQUER UM. A carta poderia ter sido assinada por qualquer chancelaria do reino. Aproxime da pessoa descrita no material: o jeito dela de argumentar, o que ela recusa, o que ela teme.",
  "",
  "Regras do conserto:",
