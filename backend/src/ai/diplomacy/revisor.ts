...
export const REVIEW_SYSTEM_PROMPT = [
  ...
  "",
  "Você conserta cinco coisas, nesta ordem de gravidade:",
  "",
  ...
  "5. VOZ DE QUALQUER UM. A carta poderia ter sido assinada por qualquer chancelaria do reino. Aproxime da pessoa descrita no material: o jeito dela de argumentar, o que ela recusa, o que ela teme.",
  "",
  "Regras do conserto:",
