...
export const HOUSE_CANON: Record<string, HouseCanon> = {
  ...
  "casa-solarion": {
    "name": "Casa Solarion",
    "population": 155000,
    "region": "Deserto de Sahr, oásis, rotas de caravanas, cânions e comunidades ligadas às fontes subterrâneas.",
    "mainCity": "Sahra-Lun: 58.000 habitantes.\n\nO restante vive em cidades de oásis, fortalezas de poços, comunidades de pastores, estações de caravana e pequenos centros de estudo.",
    ...
    "demographicPressure": "A cidade cresce mais rapidamente que a capacidade dos canais mais antigos. Novas escavações poderiam ampliar a água disponível, mas também ameaçam ruínas e estruturas que a Casa prefere estudar antes de tocar.\n\n---"
  },
  "casa-khazdrun": {
    "name": "Casa Khazdrun",
    "population": 150000,
